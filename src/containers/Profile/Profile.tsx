            ...
            <div className="profileDescription">
                <div>
                    <HtmlTag tag={"<p>"}></HtmlTag>
                        <p className="profileText">I am a student of the interactive media design major from the Icesi University of Cali Colombia.
                        <br></br>
                        <br></br>
                        ...
                        <br></br>
                        <br></br>
                        This helps me to reinforce the skills that I have acquired to program and combine it with the design components seen in the major, whit this, I can develop functional, attractive, and high-quality digital products,  that will generate a good user experience.
                        <br></br>
                        <br></br>
